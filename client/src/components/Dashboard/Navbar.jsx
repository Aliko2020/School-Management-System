        ...
        <nav className='w-full flex justify-between items-center bg-primaryLight py-12 px-2 text-white'>
            ...
            <div className='flex gap-3 items-center relative'>
                ...
                <div className="relative flex items-center gap-2 px-4">
                    ...
                    />
                    {open && (
                        <div className="absolute right-0 top-14 mt-10 w-40 bg-primaryLight text-white">
                            <ul className="py-1 text-sm">
                                <li className="px-4 py-2 hover:bg-gray-100 hover:text-primary cursor-pointer">Details</li>
                                <li className="px-4 py-2 hover:bg-gray-100 hover:text-primary cursor-pointer">Settings</li>
                                <li className="px-4 py-2 hover:bg-gray-100 hover:text-primary cursor-pointer">Update</li>
                                <li className="px-4 py-2 hover:bg-gray-100 hover:text-primary cursor-pointer">Logout</li>
                            </ul>
                        </div>
                    )}
                </div>
